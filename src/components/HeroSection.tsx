...
`;
  ...
  return (
    <section className="relative sm:min-h-[calc(100vh-4rem)] sm:min-h-[calc(100dvh-4rem)] flex flex-col justify-between pt-16 sm:pt-12 pb-24 sm:pb-12 overflow-hidden border-b border-neutral-900">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 w-full flex-1 flex flex-col justify-between">
        ...
        >
          ...
          <div className="w-full overflow-x-auto py-1 flex justify-center">
            <pre
              className={`font-mono text-[5.5px] min-[360px]:text-[6.5px] xs:text-[8.5px] sm:text-[13px] md:text-[15px] lg:text-[17px] xl:text-[18px] leading-tight text-white inline-block select-none transition-opacity duration-75 ${
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-1 w-full sm:w-auto px-2">
            <a
              href="#register"
              className="w-full sm:w-auto justify-center relative group border-2 border-white bg-white text-black px-6 sm:px-7 py-3 sm:py-3.5 font-mono font-bold tracking-wider text-xs sm:text-sm flex items-center gap-2.5 hover:bg-black hover:text-white transition-all duration-200 shadow-md"
            >
            ...
            <a
              href="#dates"
              className="w-full sm:w-auto justify-center border border-neutral-700 bg-neutral-950/60 text-neutral-300 hover:text-white hover:border-white px-5 py-3 sm:py-3.5 font-mono text-xs sm:text-sm flex items-center gap-2 transition-colors"
            >
        ...
        <motion.div
          ...
          className="flex flex-col gap-3 sm:gap-4 pt-4 pb-2 font-mono text-xs text-neutral-300 w-full"
        >
          {/* Top Row: 3 Boxes */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4 w-full">
            <div className="border border-neutral-800 bg-neutral-950/80 p-3 sm:p-4 h-full flex flex-col justify-between relative group hover:border-white/60 transition-colors">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 max-w-3xl mx-auto w-full">
            <div className="border border-neutral-800 bg-neutral-950/80 p-3 sm:p-4 h-full flex flex-col justify-between relative group hover:border-white/60 transition-colors text-left">
