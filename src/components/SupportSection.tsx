...
export function SupportSection() {
  ...
  return (
    <section id="contact" className="py-12 sm:py-24 border-b border-[rgba(247,248,239,0.13)] relative">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8 sm:mb-10 pb-4 border-b border-[rgba(247,248,239,0.13)]">
          <div>
            ...
            <div className="overflow-x-auto py-1">
              <pre className="font-mono text-[6px] sm:text-[9px] md:text-[11px] leading-tight text-[#c7f85a] select-none">
{`███████╗██╗   ██╗██████╗ ██████╗  ██████╗ ██████╗ ████████╗
██╔════╝██║   ██║██╔══██╗██╔══██╗██╔═══██╗██╔══██╗╚══██╔══╝
███████╗██║   ██║██████╔╝██████╔╝██║   ██║██████╔╝   ██║   
╚════██║██║   ██║██╔═══╝ ██╔═══╝ ██║   ██║██╔══██╗   ██║   
...
╚══════╝ ╚═════╝ ╚═╝     ╚═╝      ╚═════╝ ╚═╝  ╚═╝   ╚═╝   `}
          ...
          <div className="font-mono text-xs text-[#c8cfbd] flex items-center gap-2">
            ...
            <span>[HELPDESK_OPERATIONAL]</span>
          </div>
        </div>
